import"./vue-C5dO_luG.js";import{u as y,a as b}from"./vue-router-BozZHOWV.js";import{d as w,r as e,bS as S,bT as C,v as M,f as A,h as d,o as D,c as F,i as n,j as h,u as s,bU as E,bV as k,a as O,m as P,bW as z}from"./@vue-CEwL1emF.js";import{F as T}from"./file-saver-BBbes1LX.js";import{t as L}from"./html-to-image-BMEuJ5ne.js";import{_ as R}from"./index-BlbMRq7A.js";import"./ace-builds-BgbZLK3Y.js";import"./vuex-Ba7ek5fU.js";import"./path-browserify-CtykbOjM.js";import"./@vueuse-DfzPTH68.js";import"./axios-DHSC6jYe.js";import"./js-cookie-Cz0CWeBA.js";import"./element-plus-DMVJK10x.js";import"./lodash-es-WEemOz_S.js";import"./@element-plus-DNaH03KG.js";import"./@popperjs-D9SI2xQl.js";import"./@ctrl-r5W6hzzQ.js";import"./dayjs-CdRyolhI.js";import"./async-validator-D3FX-SGt.js";import"./memoize-one-BdPwpGay.js";import"./normalize-wheel-es-B6fDCfyv.js";import"./@floating-ui-CtcGg-6p.js";import"./nprogress-DI8p4ty5.js";/* empty css                    */import"./element-easy-form-4sEWskrm.js";import"./mockjs-DBNDAG0j.js";import"./vuedraggable-CHX8LlEE.js";import"./sortablejs-Df4VMxQp.js";import"./vue3-ace-editor-D2yfFFZ4.js";import"./resize-observer-polyfill-B1PUzC5B.js";import"./uuid-D8aEg3BZ.js";const I=()=>`
  <template>
  <div
    class="content"
    :style="{
...
#huikuan-echarts {
  ...
  `,he=I(),me=j(),ue=B(),fe=W(),xe=$(),ge=_(),ve=de(),ye=X(),be=V(),we=H(),Se=Y(),Ce=N(),Me=U(),Ae=K(),De=Z(),Fe=J(),Ee=Q(),ke=ee(),Oe=te(),Pe=ae(),ze=ie(),Te=re(),Le=ne(),Re=se(),Ie=oe(),je=le(),Be=pe(),We=ce(),$e=q(),_e=G(),Xe=Object.freeze(Object.defineProperty({__proto__:null,FunnelPlot1:Fe,FunnelPlot2:Be,Pie1:xe,Pie2:ge,Pie3:ve,Pie3D1:he,Pie3D2:me,Pie3D3:ue,Pie3D4:fe,Pie4:ye,Progress1:Ee,WaterPolo:ze,bar1:be,barY:we,dimensionalBar:Se,dimensionalBar2:$e,dimensionalBar3:_e,filletCorner:Ce,filletCornerAndLine:ke,filletCornerAndLine2:We,line:Me,linewaterfall:Ae,map1:je,mapGradient:Oe,pointerEcharts:Te,pointerEcharts2:Le,taperBar:De,worldMap1:Pe,worldMap2:Re,worldMap3d:Ie},Symbol.toStringTag,{value:"Module"})),Ve=`
/**
 * 
...
export const getParametricEquation = (
    ...
    let offsetX = isSelected ? Math.cos(midRadian) * offset : 0;
    let offsetY = isSelected ? Math.sin(midRadian) * offset : 0;
  ...
  // let hoverRate =1 
    ...
    return {
      ...
      z: function(u, v) {
          ...
          // 调整扇形高度
          return offsetZ + (Math.sin(v) > 0 ? 0.1 * (h+10) : -1);
      }
    };
  };
 ...
 */
  export const getSeriesPie3D = ({
    pieData, internalDiameterRatio = 1 / 3,pieHeight,unit,
    isSelected=false,offset=0.6,
    line=1
  })  => {
    // echart series 数据
    let series = [];
...
// 允许事件冒泡
event: null,
        name: typeof element.name === "undefined" ? 'series'+index : element.name,
        type: "surface",
        parametric: true,
        shading: "realistic",
        wireframe: {
    ...
    // sumValue = sumValue==0?100:sumValue;
    let allotment = sumValue==0?(pieData.length):sumValue;
    // 生成3d饼状图
    for (let i = 0; i < series.length; i++) {
      // 计算饼状图 结束位置
      endValue = startValue + ( sumValue==0?1:series[i].pieData.value) ;
      // 获取开始比例 起始值
      series[i].pieData.startRatio = startValue / allotment;
      // 获取结束比例 终始值
      series[i].pieData.endRatio = endValue / allotment;
      ...
      series[i].parametricEquation = getParametricEquation(
        ...
        pieHeight?pieHeight:series[i].pieData.value==0?10:series[i].pieData.value,
        offset
      );
    ...
    let posZ = ( sumValue==0?1:Math.log(Math.abs(series[i].pieData.value + 1)) * 0.13)//Math.log(Math.abs(series[i].pieData.value + 1)) * 0.13;
    let flag =
    ...
    let turningPosArr = [
        posX*1.4, 
        posY * (1.8+line) + (i * 0.1 * flag) + (flag < 0 ? -0.5 : 0), 
        posZ * (3+line)
    ]
    let endPosArr = [
        posX * (2) + (i * 0.1 * flag) + (flag < 0 ? -0.5 : 0), 
        posY * (1.9+line) + (i * 0.1 * flag) + (flag < 0 ? -0.5 : 0), 
        posZ * (4+line)
    ]
      linesSeries.push(
        {
...
event: null,
          label: {
            ...
            formatter: function(params) {
            return !series[i].pieData.proportion
            ?
            \`{a|\${params.name} 
 }{b| \${params.data.nameValue}\${unit?unit:''}}\`
            : 
            \`{a|\${params.name} 
 }{b| \${params.data.nameValue}\${unit?unit:''}(\${params.data.proportion}%)}\`;
            },
            rich: {
              a: {
                color: "rgba(211, 228, 254, 1)",
          ...
          data: [
            {
              name: series[i].name ,
              nameValue :series[i].pieData.value,
              proportion :series[i].pieData.proportion, 
              value: endPosArr,
            },
          ],
        }
...
`,He={class:"white-bg"},Ye={class:"renderEcharts jcfend"},t="/vue.example",qe=w({__name:"renderEcharts",setup(Ge){y();const l=b();e("");const m=()=>{var c=document.getElementById("repl");const i=c.querySelector("iframe");var r=i.contentDocument||i.contentWindow.document;console.log("iframeElement :>> ",o);var o=r.getElementById("app");L(o).then(v=>{T.saveAs(v,`${l.params.text}.png`)})},{importMap:a,vueVersion:u,productionMode:f}=S({runtimeProd:t+"/js/runtime-dom.3.4.19.esm-browser.prod.js",serverRenderer:t+"/js/server-renderer.3.4.19.esm-browser.js"}),x=e({welcomeSFC:Xe[l.params.text]});e("index.vue");const g=e({"src/tool.js":new z("src/tool.js",Ve,!1)});a.value.imports["echarts-liquidfill"]=t+"/js/echarts-liquidfill.3.1.0.min.js",a.value.imports.echarts=t+"/js/echarts.5.5.0.min.js",a.value.imports["echarts-gl"]=t+"/js/echarts-gl.2.0.9.min.js";const p=C({vueVersion:u,builtinImportMap:a,template:x,files:g});return f.value=!0,e(!0),M({}),A(()=>{console.log("store :>> ",p)}),(c,i)=>{const r=d("el-button"),o=d("el-scrollbar");return D(),F("div",He,[n(o,{class:"renderEchartsEdit"},{default:h(()=>[n(s(E),{theme:"dark",layout:"1111",store:s(p),class:"repl",editor:s(k),id:"repl"},null,8,["store","editor"]),O("div",Ye,[n(r,{type:"primary",onClick:m},{default:h(()=>[P("下载图片")]),_:1})])]),_:1})])}}}),At=R(qe,[["__scopeId","data-v-be11eec2"]]);export{At as default};
